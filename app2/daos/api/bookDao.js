...
const bookDao = {
    ...
    findBookById: (res, table, id)=>{
        ...
        con.execute(
            `SELECT b.book_id, b.title, a.author_id, a.author, p.pub_id, p.publisher, b.copyright_year, b.edition, b.edition_year, f.format_id, f.format, b.binding, b.rating, b.language, b.num_pages, b.cover_image, b.qty
            FROM book b
            JOIN author a USING (author_id)
            JOIN publisher p USING (pub_id)
            JOIN format f USING (format_id)
