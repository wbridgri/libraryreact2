-- DATA ONLY — use this when tables already exist (do not run railway-init.sql again).

insert into author(author) values ('Justin Torres');
...
insert into publisher(publisher) values ('Picador');
...
insert into book (title, author_id, pub_id, copyright_year, edition, edition_year, binding, rating, language, num_pages, cover_image, qty, format_id)
...
INSERT INTO book (title, author_id, pub_id, copyright_year, edition, edition_year, binding, rating, language, num_pages, cover_image, qty, format_id) VALUES
...
(1, 1), (1, 2), (2, 3), (2, 4), (2, 5), (3, 4), (3, 6), (3, 3),
(4, 4), (4, 7), (5, 4), (5, 8), (6, 4), (6, 10), (7, 10), (8, 3),
(8, 5), (8, 11), (9, 2), (9, 12), (10, 4), (10, 7), (10, 9), (11, 7),
(11, 9), (12, 3), (13, 7), (13, 9), (14, 7), (15, 2), (15, 4), (15, 9),
(16, 2), (16, 4), (16, 10), (17, 3), (17, 4), (18, 10), (19, 1), (19, 13), (20, 3);
